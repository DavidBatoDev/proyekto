...
CREATE TABLE public.project_member_time_rates (
  ...
  CONSTRAINT project_member_time_rates_project_member_id_fkey FOREIGN KEY (project_member_id) REFERENCES public.project_members(id),
...
CREATE TABLE public.project_members (
  ...
  project_id uuid NOT NULL,
  user_id uuid,
  role text NOT NULL DEFAULT 'member'::text CHECK (role = ANY (ARRAY['consultant'::text, 'client'::text, 'member'::text])),
