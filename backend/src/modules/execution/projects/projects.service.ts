...
export class ProjectsService {
   ...
   *
   * The Gmail plumbing that used to live here (token refresh, MIME assembly,
   * base64url) is gone — MailerService owns it, and the body moved to
   * project-invite-email.template.ts.
   */
