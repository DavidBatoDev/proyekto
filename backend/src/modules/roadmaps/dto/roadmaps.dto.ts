...
export class UpdateEpicDto {
  @IsString() @IsOptional() @MaxLength(200) title?: string;
  @IsString() @IsOptional() @IsNullable() description?: string | null;
  @IsEnum(['critical', 'high', 'medium', 'low', 'nice_to_have'])
  @IsOptional()
  priority?: string;
  @IsEnum([
  ...
  @IsDateString() @IsOptional() @IsNullable() start_date?: string | null;
  @IsDateString() @IsOptional() @IsNullable() end_date?: string | null;
