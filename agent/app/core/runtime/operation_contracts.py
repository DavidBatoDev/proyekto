"""Operation-level contract helpers shared by staging, dedup and the loop's
stage-tool validation: stable signatures, title reads, semantic-contract
validation and the user-facing guidance strings for each failure reason."""
