...
export const STATIC_ROUTES = [
  ...
  { path: "/engagements/finance", group: "consultant", auth: true },
  { path: "/engagements/finance/contracts", group: "consultant", auth: true },
  { path: "/engagements/finance/invoices", group: "consultant", auth: true },
  { path: "/engagements/finance/invoices/new", group: "consultant", auth: true },
