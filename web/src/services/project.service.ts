...
class ProjectService {
	...
	private normalizeResourcesPayload(raw: unknown): ProjectResourcesPayload {
		...
		const foldersRaw = Array.isArray(candidate?.folders)
			? candidate.folders
			: [];
	...
	async update(
		...
		if (!response.ok) {
			const error = await response.json();
			throw new Error(
				extractApiErrorMessage(error, "Failed to update project"),
			);
		}
	...
	async list(): Promise<Project[]> {
		...
		if (!response.ok) {
			const error = await response.json();
			throw new Error(
				extractApiErrorMessage(error, "Failed to fetch projects"),
			);
		}
	...
	async getDashboardSummary(params?: {
		...
		if (params?.member_user_id)
			search.set("member_user_id", params.member_user_id);
	...
	async addMember(
		...
		if (!response.ok) {
			...
			throw new Error(extractApiErrorMessage(err, "Failed to add member"));
		}
		const result = await response.json();
	...
	async updateMemberPosition(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to update position"));
		}
		const result = await response.json();
		return result.data ?? result;
	}
	...
	async updateMember(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to update member"));
		}
		const result = await response.json();
		return result.data ?? result;
	}
	...
	async inviteByEmail(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to send invite"));
		}
	...
	async getMyInvites(): Promise<ProjectInvite[]> {
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to fetch invites"));
		}
	...
	async removeMember(projectId: string, memberId: string): Promise<void> {
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to remove member"));
		}
	}
	...
	async leaveProject(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to leave project"));
		}
	...
	async deleteProject(projectId: string): Promise<void> {
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to delete project"));
		}
	}
	...
	async getResources(projectId: string): Promise<ProjectResourcesPayload> {
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to fetch resources"));
		}
	...
	async createResourceFolder(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to create folder"));
		}
	...
	async updateResourceFolder(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to update folder"));
		}
	...
	async deleteResourceFolder(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to delete folder"));
		}
	}
	...
	async reorderResourceFolders(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to reorder folders"));
		}
	...
	async createResourceLink(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to create link"));
		}
	...
	async updateResourceLink(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to update link"));
		}
	...
	async deleteResourceLink(projectId: string, linkId: string): Promise<void> {
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to delete link"));
		}
	}
	...
	async reorderResourceLinks(
		...
		if (!response.ok) {
			const err = await response.json();
			throw new Error(extractApiErrorMessage(err, "Failed to reorder links"));
		}
