...
import { Pencil, RotateCcw, Send, Sparkles, X } from "lucide-react";
...
const FEATURES = [
	...
	},
	{
		...
		description:
			"Introduce an interactive product tour tailored to user goals.",
								...
								{isDone ? (
									...
									<>
										<p className="text-[11px] leading-relaxed text-slate-600">
											...
											three high-impact features. Say "apply this plan" to
											proceed.
										</p>
										{/* Plan proposal card */}
						...
						<span className="flex-1 truncate text-[11px]">
							{phase === 0 ? (
								<span className="text-slate-700">
									add an epic for onboarding improvements
									<span
										className="ml-px inline-block h-[0.85em] w-px translate-y-px bg-slate-600 align-middle"
										style={{ animation: "demo-caret 1s step-end infinite" }}
									/>
								</span>
							) : (
