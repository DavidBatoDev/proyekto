...
import { ClipboardPen, Gauge, Users } from "lucide-react";
			...
			<div ref={ref} className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-10">
				<div className="relative text-center">
					...
					<p className="mx-auto mt-3 max-w-2xl text-sm text-slate-600 sm:text-base">
						From idea to execution — break your project into clear steps, assign
						ownership, and keep everything moving.
					</p>
				</div>
				...
				<div className="mt-4 grid gap-5 lg:grid-cols-3">
					{steps.map((step, index) => (
						...
						>
							<p className="text-6xl font-semibold leading-none text-slate-300">
								{step.number}
							</p>
