...
const useCases = [
	{
		...
		examples:
			"Examples: Website Build · Logo Project · Landing Page Copywriting",
	},
	{
		title: "Ongoing work",
		description:
						...
						>
							...
							<div className="relative z-10 flex h-full flex-col">
								...
								<p className="mt-4 text-sm leading-relaxed text-blue-100/90">
									Your project isn't always the same shape. Sometimes it's a
									one-time build, sometimes it keeps evolving — and sometimes
									it's both.
								</p>
