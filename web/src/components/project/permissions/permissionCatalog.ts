...
export const PERMISSION_SECTIONS: PermissionSectionMeta[] = [
	{
		...
		label: "Access",
		description:
			"Page-level visibility gates. Disable to hide entire surfaces.",
		permissions: [
			p(
				"access",
				"roadmap",
				"Open Roadmap",
				"View the roadmap canvas in this project.",
			),
			p(
				"access",
				"work_items",
			...
			p(
				...
				"resources",
				"Open Resources",
				"Open the project resources library.",
			),
			p(
				"access",
				"project_settings",
	...
	},
	{
		...
		permissions: [
			p(
				...
				"view",
				"View roadmap",
				"Read roadmap epics, features, and tasks.",
			),
			p(
				"roadmap",
				"edit",
				"Edit roadmap",
				"Modify epics, features, tasks, and structure.",
				["roadmap.view", "access.roadmap"],
			),
			p("roadmap", "comment", "Comment", "Leave comments on roadmap items.", [
				"roadmap.view",
			]),
			p(
				"roadmap",
				"promote",
				"Promote drafts",
				"Promote draft roadmap items to active.",
				["roadmap.edit"],
			),
			p(
				"roadmap",
			...
			p(
				...
				"edit_metadata",
				"Edit metadata",
				"Edit titles, descriptions, statuses.",
				["roadmap.edit"],
			),
			p(
				"roadmap",
			...
			p(
				...
				"create_tasks",
				"Create tasks",
				"Create new tasks under features.",
				["roadmap.edit"],
			),
			p(
				"roadmap",
				"edit_tasks",
				"Edit tasks",
				"Edit task fields, status, and ordering.",
				["roadmap.edit"],
			),
			p(
				"roadmap",
				"share",
				"Share roadmap",
				"Generate share links and invite viewers.",
				["roadmap.edit"],
			),
			p(
				"roadmap",
				"export",
				"Export roadmap",
				"Export the roadmap snapshot to a file.",
				["roadmap.view"],
			),
			p(
				"roadmap",
				"dev_mode",
				"Dev mode",
				"Use developer-mode tooling on the canvas.",
				["roadmap.edit"],
			),
		],
	},
	{
		...
		permissions: [
			...
			p(
				...
				"manage",
				"Manage members",
				"Invite, remove, and change member roles. Also covers curating team-derived members onto the project.",
				["members.view"],
			),
			p(
				"members",
				"edit_permissions",
				"Edit permissions",
				"Override per-member capability flags.",
				["members.manage"],
			),
			p(
				"members",
				"edit_position",
				"Edit positions",
				"Set or change other members' position labels.",
				["members.view"],
			),
		],
	},
	{
		...
		permissions: [
			p(
				...
				"view",
				"View attached teams",
				"See which teams contribute to this project and their curated members.",
			),
			p(
				"teams",
				"manage",
				"Manage attached teams",
				"Attach or detach teams, set the primary team, and change a team's default project role.",
				["teams.view"],
			),
		],
	},
	{
		...
		permissions: [
			...
			p(
				...
				"Edit project descriptions and content.",
				["access.project_settings"],
			),
			p(
				"project",
				...
				"See internal-only project content.",
				["access.project_settings"],
			),
		],
	},
	{
		...
		permissions: [
			...
			p(
				...
				"create_channels",
				"Create channels",
				"Create new channels in this project.",
				["chat.view_channels"],
			),
			p(
				"chat",
				"manage_channels",
				"Manage channels",
				"Edit, archive, and delete channels.",
				["chat.create_channels"],
			),
			p(
				"chat",
				"view_internal_channels",
				"View internal channels",
				"Read internal-only channels.",
				["chat.view_channels"],
			),
			p(
				"chat",
			...
			p("chat", "share_files", "Share files", "Attach files to messages.", [
				"chat.send_messages",
			]),
	...
	},
	{
		...
		permissions: [
			p(
				...
				"view",
				"View resources",
				"Browse the project resources library.",
			),
			p("resources", "upload", "Upload resources", "Add new files and links.", [
				"resources.view",
			]),
			p("resources", "delete", "Delete resources", "Remove files and links.", [
				"resources.upload",
			]),
		],
	},
