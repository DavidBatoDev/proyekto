	...
	return createPortal(
		<>
			...
			<motion.div
				...
				className="fixed z-[120] flex max-h-[min(70vh,520px)] w-[320px] flex-col rounded-lg border border-gray-200 bg-white shadow-xl"
				role="dialog"
          ...
          pinned so the primary action is always reachable. */}
				...
				<div className="shrink-0 border-t border-gray-200 p-2">
					<button
						...
						className="flex w-full items-center justify-center gap-2 ai-gradient-bg rounded-md px-2 py-2 text-xs font-semibold text-white shadow-sm transition-opacity hover:opacity-90"
					>
						<Plus size={14} />
						New thread
					</button>
