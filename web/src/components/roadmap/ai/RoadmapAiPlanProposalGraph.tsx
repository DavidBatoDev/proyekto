...
const cardClass: Record<NodeKind, string> = {
	...
	feature:
		"border-purple-200 bg-purple-50/60 dark:border-purple-900/70 dark:bg-purple-950/30",
...
export const RoadmapAiPlanProposalGraph: FC<
	RoadmapAiPlanProposalGraphProps
> = ({ epics }) => {
