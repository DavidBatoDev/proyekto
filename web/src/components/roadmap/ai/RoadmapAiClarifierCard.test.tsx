...
describe("RoadmapAiClarifierCard — built-in catch-all", () => {
	it("still renders its own Other row when the model supplies none", () => {
		render(
			<RoadmapAiClarifierCard card={cardWithoutCatchAll} onSubmit={vi.fn()} />,
		);
