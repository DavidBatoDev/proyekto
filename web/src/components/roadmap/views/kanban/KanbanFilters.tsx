		...
		<div className="border-b border-slate-200 bg-linear-to-b from-slate-50 to-white">
			...
			<div className="flex items-center gap-2 px-3 py-2 md:hidden">
				...
				<button
					...
					className={`relative shrink-0 inline-flex items-center gap-1 rounded-lg border px-2.5 py-1.5 text-xs font-medium transition-colors ${
				...
				{hasAny && (
					<button
						type="button"
						onClick={clearAll}
						className="shrink-0 inline-flex items-center gap-1 rounded-md border border-slate-200 bg-white px-2 py-1.5 text-xs font-medium text-slate-600 hover:bg-slate-100"
						title="Clear filters"
					>
						<X className="w-3 h-3" />
					</button>
				...
				<div className="flex flex-col gap-2.5 px-3 pb-3 pt-1 md:grid md:grid-cols-10 md:gap-6 md:px-4 md:py-3">
					...
					<div className="flex flex-col gap-2 md:col-span-7 md:pr-6 md:border-r md:border-slate-200 md:relative">
						...
						<div className="relative pl-8 flex items-center min-w-0">
							<div className="hidden md:block absolute left-4 top-[-23px] w-4 h-9 border-l-2 border-b-2 border-slate-300 rounded-bl-xl pointer-events-none" />
							<FilterRow
								tagLabel="Features"
								tagColor="black"
					...
					{/* Right: Assignees + Search (search desktop-only) */}
