...
export function RichTextToolbar({
	...
	return (
		<div
			className={`flex items-center gap-1 border-b border-gray-200 bg-gray-50 rounded-t-lg flex-wrap ${compact ? "px-2 py-1" : "px-3 py-2"}`}
		>
			{/* Left side tools */}
			...
			<div className="flex items-center gap-1">
				...
				{tools.includes("more") && (
					<MoreTool onCommand={onCommand} activeFormats={activeFormats} />
				)}
			</div>
