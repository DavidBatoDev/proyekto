						...
						{!isEdit ? (
							<div className="relative">
								...
								<input
									...
									className="w-full pl-9 pr-3 py-2 border border-input rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none"
								/>
								{search && (
										...
										{filteredLangs.length > 0 ? (
											filteredLangs.map((lang) => (
												<button
													...
													className="w-full text-left px-3 py-2 text-sm hover:bg-muted/40 text-foreground"
												>
													{lang.name}
												</button>
											))
							...
							<input
								...
								className="w-full px-3 py-2 border border-input rounded-lg text-sm bg-muted/40 text-muted-foreground cursor-not-allowed"
							/>
						)}
					</div>
