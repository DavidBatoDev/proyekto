...
export function BookMeetingModal({
	...
	const submit = () => {
		...
		if (videoOption === "external_link" && !meetingUrl.trim()) {
			setErrorMessage(
				"Paste the meeting link, or switch to an auto-generated room.",
			);
			return;
		}
					...
					<div className="p-5 space-y-4">
						<div>
							<input
								...
								className="w-full border-0 border-b border-gray-300 bg-transparent px-0 py-2 text-lg focus:border-primary focus:outline-none focus:ring-0 placeholder:text-gray-400"
							/>
						</div>
