	...
	return (
		<div className="relative min-h-screen overflow-hidden bg-background pt-20 text-foreground">
			...
			<div className="absolute inset-0 pointer-events-none">
				...
				<motion.div
					className="absolute top-0 right-10 w-[400px] h-[400px] bg-[#ff993333] rounded-full blur-3xl opacity-40 mix-blend-multiply"
					animate={{ scale: [1, 1.2, 1], x: [0, -30, 0], y: [0, 40, 0] }}
					transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
				/>
				<motion.div
					className="absolute top-20 left-10 w-[350px] h-[350px] bg-pink-300 rounded-full blur-3xl opacity-20 mix-blend-multiply"
			...
			<div className="max-w-[1440px] mx-auto px-6 py-12 relative z-10">
				...
				<div className="text-center max-w-3xl mx-auto mb-12">
					<motion.h1
						...
						className="text-4xl md:text-5xl font-extrabold text-[#333438] mb-4 tracking-tight"
					>
						Discover Top{" "}
						<span className="text-transparent bg-clip-text bg-linear-to-r from-[#ff9933] to-[#e91e63]">
							Talent
						</span>
					</motion.h1>
					<motion.p
						...
						className="text-lg text-[#61636c]"
					>
						Curated discovery engine for consultants. Build your dream
						development team from our private pool of vetted professionals.
					</motion.p>
				</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
						...
						<div className="md:col-span-2 relative group">
							...
							<select
								...
								onChange={(e) =>
									setSort(
										e.target.value as "rating_desc" | "rate_asc" | "rate_desc",
									)
								}
				...
				<div className="min-h-[400px]">
					{talentQuery.isLoading ? (
						...
						>
							...
							<h2 className="text-2xl font-bold text-[#333438] mb-2">
								No talent found
							</h2>
