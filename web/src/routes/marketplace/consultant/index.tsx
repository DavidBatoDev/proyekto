	...
	return (
		<section className="relative pt-6 sm:pt-10">
			...
			<div className="relative mx-auto max-w-4xl text-center">
				...
				>
					Proyekto is the operating system for independent consultants. Bring
					your clients and your network — we handle the workspace, the vetted
					talent bench, escrow, and invoicing.
				</motion.p>
...
const personas = [
	{
		...
		description:
			"Fractional CTOs, heads of product, or ops leads running 2–4 engagements at once.",
	},
	{
		icon: Workflow,
		title: "Freelance consultants",
		description:
			'Solo consultants who keep getting asked, "can you bring a team for this?"',
	},
	{
		icon: Building2,
		title: "Boutique-agency founders",
		description:
			"Tired of running the back office and ready to ship faster with less overhead.",
	},
	{
		icon: Crown,
		title: "Ex-Big-4 / ex-McKinsey",
		description:
			"Building independent practice, looking for firm-quality tooling without the firm.",
	},
];
		...
		<section className="relative mt-20 lg:mt-24">
			<div className="text-center">
				...
				<p className="mt-3 text-sm text-slate-600 sm:text-base">
					We're selective on purpose. Not a fit if you're new to client-facing
					delivery.
				</p>
			</div>
	...
	return (
		<section className="relative mt-20 lg:mt-24">
			<div className="text-center">
				...
				<p className="mt-3 text-sm text-slate-600 sm:text-base">
					Every application is reviewed by a human. Most consultants hear back
