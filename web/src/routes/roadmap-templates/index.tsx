	...
	return (
		<main className="min-h-screen bg-slate-50 pt-24 text-slate-950">
			<div className="mx-auto max-w-7xl px-4 pb-20 sm:px-6">
				...
				<div className="mb-8 grid gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:grid-cols-6">
					...
					<div className="flex gap-2 md:col-span-6">
						{[
							...
							<button
								...
								className={`rounded-full px-3 py-1.5 text-xs font-semibold ${scheduleKind === item.value ? "bg-slate-900 text-white" : "bg-slate-100 text-slate-600"}`}
							>
								{item.label}
							</button>
						))}
