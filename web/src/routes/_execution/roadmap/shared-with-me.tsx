...
import { Calendar, ExternalLink, Loader2, Share2 } from "lucide-react";
import { useEffect, useState } from "react";
import {
	roadmapSharesServiceAPI,
	type SharedRoadmapInfo,
} from "@/services/roadmap-shares.service";

export const Route = createFileRoute("/_execution/roadmap/shared-with-me")({
				...
				{!error && sharedRoadmaps.length > 0 && (
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
						{sharedRoadmaps.map((item) => {
							...
							const sharedAgo = formatDistanceToNow(new Date(item.sharedAt), {
								addSuffix: true,
							});
							...
							return (
								<Link
									...
									params={{
										projectId: item.roadmap.project_id || "n",
