...
export const projectKeys = {
	...
	resources: (projectId: string) =>
		["project", "resources", projectId] as const,
...
export async function fetchLinkedRoadmap(
	projectId: string,
...
export async function fetchRoadmapFull(
	roadmapId: string,
): Promise<FullRoadmap> {
	return roadmapService.getFull(roadmapId);
}

export async function fetchAllRoadmapsFull(): Promise<
