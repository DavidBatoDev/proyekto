...
- Sections 00-12 describe SHIPPED behaviour. Section 13-proposals holds general unbuilt designs. Section 14-engagement is the dedicated exception for the locked but unapplied P4b schema and scenarios. Draft pages in either section must clearly say they are not active. When a proposal ships, rewrite it as current-state docs under its owning section and remove the obsolete draft.
