...
service talks to. It's organized as one root module importing 40 self-contained
...
| [authorization-axes.md](./authorization-axes.md) | The six independent authorization axes, which question each answers, and the anti-patterns |
...
| [modules.md](./modules.md) | The 31 feature modules — purpose, tables, dependencies |
