...
Talent, so vision, planning, collaboration, and accountability all live in one
workspace.

> If you're new to Proyekto, read these in order: [roles and capabilities](./personas.md) →
...
| Concept | Lives in |
| --- | --- |
| Roles & auth | [Backend → auth & guards](../03-backend/auth-and-guards.md) |
