...
| [finance/](./finance/README.md) | Payouts, invoices, contract pricing boundaries, and the retired escrow — plus [finance books](./finance/finance-books.md) (the book-based surface, book roles, contract-gated time) and [document imports](./finance/document-imports.md) |
